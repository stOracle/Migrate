									...
									<xsl:for-each select="n1:TablesCollection">
										<xsl:for-each select="n1:TableDetails">
											...
											<xsl:if test="count( n1:ConstraintsCollection )">
												...
												<altova:line-break/>
												<xsl:variable name="altova:table">
													<fo:table border-collapse="collapse" width="25cm" table-layout="fixed" altova:hide-rows="body-empty" altova:hide-cols="body-empty">
														<fo:table-column column-width="3cm"/>
														<fo:table-column column-width="3cm"/>
																						...
																						<xsl:if test="count( n1:RangesCollection ) != 0">
																							<xsl:variable name="altova:table">
																								<fo:table border-collapse="collapse" width="18.5cm" table-layout="fixed">
																									...
																									<fo:table-header background-color="#d9f5ff" start-indent="0pt">
																										<fo:table-row>
																											<fo:table-cell number-columns-spanned="3" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thin" border-left-color="black" border-left-style="solid" border-left-width="thin" border-right-color="black" border-right-style="solid" border-right-width="thin" border-top-color="black" border-top-style="solid" border-top-width="thin" font-size="xx-small" font-weight="bold" padding="3" display-align="before">
																												<fo:block-container overflow="hidden">
																													<fo:block text-align="center">
																														<fo:inline>
																										...
																										<fo:table-row>
																											<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thin" border-left-color="black" border-left-style="solid" border-left-width="thin" border-right-color="black" border-right-style="solid" border-right-width="thin" font-size="xx-small" font-weight="bold" padding="3" display-align="before">
																												<fo:block-container overflow="hidden">
																													<fo:block text-align="center">
																														<fo:inline>
																											...
																											<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thin" border-right-color="black" border-right-style="solid" border-right-width="thin" font-size="xx-small" font-weight="bold" padding="3" display-align="before">
																												<fo:block-container overflow="hidden">
																													<fo:block text-align="center">
																														<fo:inline>
																						...
																						<xsl:if test="count( n1:ValueListsCollection ) != 0">
																							...
																							<xsl:variable name="altova:table">
																								<fo:table border-collapse="collapse" width="18.5cm" table-layout="fixed">
																									...
																									<fo:table-header background-color="#d9f5ff" start-indent="0pt">
																										<fo:table-row>
																											<fo:table-cell number-columns-spanned="2" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thin" border-left-color="black" border-left-style="solid" border-left-width="thin" border-right-color="black" border-right-style="solid" border-right-width="thin" border-top-color="black" border-top-style="solid" border-top-width="thin" font-size="xx-small" font-weight="bold" padding="3" display-align="before">
																												<fo:block-container overflow="hidden">
																													<fo:block text-align="center">
																														<fo:inline>
