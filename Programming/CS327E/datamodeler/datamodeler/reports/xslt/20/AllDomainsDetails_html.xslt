																...
																<xsl:if test="count( n1:CheckConstraintsCollection ) != 0">
																	<xsl:variable name="altova:table">
																		<table style="border-collapse:collapse; width:24.5cm; " border="0" cellpadding="3" cellspacing="0">
																			...
																			<thead style="background-color:#d9f5ff; ">
																				<tr>
																					<th colspan="2" style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-left-color:black; border-left-style:solid; border-left-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; border-top-color:black; border-top-style:solid; border-top-width:thin; font-size:xx-small; font-weight:bolder; text-align:center; width:21.5cm; ">
																						<span>
																				...
																				<tr>
																					<th style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-left-color:black; border-left-style:solid; border-left-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; font-size:xx-small; font-weight:bolder; text-align:center; width:21.5cm; ">
																						<span>
																							<xsl:text>Text</xsl:text>
																						</span>
																					</th>
																					<th style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; font-size:xx-small; font-weight:bolder; text-align:center; width:3cm; ">
																						<span>
