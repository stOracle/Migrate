																...
																<tbody>
																	<xsl:for-each select="n1:LOVCollection">
																		<xsl:for-each select="n1:LOVDetails">
																			<tr>
																				<td style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-left-color:black; border-left-style:solid; border-left-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; border-top-color:black; border-top-style:solid; border-top-width:thin; font-size:xx-small; width:1.7cm; word-wrap:break-word; ">
																					<xsl:choose>
																						<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
