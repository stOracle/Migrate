															...
															<xsl:for-each select="$XML">
																<xsl:for-each select="n1:SearchResults">
																	<xsl:for-each select="n1:CompanyName">
																		<altova:inline-container-substitute border-collapse="collapse" empty-cells="show" font-family="Georgia" font-size="8pt" font-weight="bold" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
																			<xsl:apply-templates/>
																		</altova:inline-container-substitute>
																	</xsl:for-each>
																</xsl:for-each>
