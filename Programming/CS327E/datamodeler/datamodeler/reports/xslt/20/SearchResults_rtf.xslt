...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="http://oracle.com/datamodeler/reports/searchresults" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<xsl:for-each select="$XML">
				...
				<altova:paragraph altova:whitespace="preserve-all" altova:selector="center*" altova:character-styles="\fs26\b\f0\fs24" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0\qc" altova:is-div="true">
	...
	<xsl:template name="Single_CRLF">
		<xsl:param name="templatetablelevel" select="0"/>
		<altova:paragraph altova:whitespace="preserve-all" altova:selector="div*" altova:character-styles="\fs16\f0\fs24" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0" altova:is-div="true">
			<altova:text-block altova:whitespace="preserve-all" altova:selector="*" altova:character-styles="\fs16" altova:character-reset-styles="\fs24">
	...
	<xsl:template name="Wide_CRLF">
		<xsl:param name="templatetablelevel" select="0"/>
		<altova:paragraph altova:whitespace="preserve-all" altova:selector="p*" altova:character-styles="\fs16\f0\fs24" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0\sb167\sa167" altova:is-div="false"/>
	</xsl:template>
	...
	<xsl:template name="altova:Section_0_FooterRight">
		...
		<altova:table>
			...
			<altova:table-row>
					...
					<xsl:for-each select="$XML">
						<xsl:for-each select="n1:SearchResults">
							<xsl:for-each select="n1:CompanyName">
								<altova:text-block altova:whitespace="preserve-all" altova:selector="*" altova:character-styles="\f4\fs16\b" altova:character-reset-styles="\f0\fs24\b0">
									<xsl:apply-templates/>
								</altova:text-block>
							</xsl:for-each>
						</xsl:for-each>
				...
				<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\ql\sl0">
					<altova:TableCellStyles altova:nColSpan="1">
						<xsl:text>\clvertalc</xsl:text>
					</altova:TableCellStyles>
					<altova:text-block altova:whitespace="preserve-all" altova:selector="*">
	...
	<xsl:variable name="altova:paragraph-style-selectors-in-use" select="('p','div','address','center','blockquote','fieldset','pre','pre-wrap','h1','h2','h3','h4','h5','h6','center*','div*','p*')"/>
	...
	<xsl:template match="/">
		<xsl:for-each select="$altova:nodesAllSeparateDocuments">
			...
			<xsl:result-document href="{$altova:nodeDocument/@altova:Url}">
				...
				<xsl:text>{\s15\qc\sl0\f0\fs24\fs26\b\snext0 Center ;}</xsl:text>
				<xsl:text>{\s16\sl0\li300\f0\fs24\snext0 Paragraph ;}</xsl:text>
				<xsl:text>{\s17\sl0\sb167\sa167\f0\fs24\fs16\snext0 Normal ;}</xsl:text>
