				...
				<fo:static-content flow-name="odd-page-footer">
					<fo:block-container height="1.30cm" overflow="hidden" display-align="after">
						<fo:block font-family="Tahoma" font-size="xx-small">
							...
							<fo:table font-size="xx-small" width="17cm" table-layout="fixed" border-spacing="0">
						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="n1:Objects">
								...
								<xsl:if test="string-length(n1:DesignName) &gt; 0">
									...
									<fo:table border-collapse="collapse" width="17cm" table-layout="fixed">
											...
											<xsl:when test="n1:IsDMDImport = &apos;Y&apos;">
												<xsl:if test="count(//n1:Object[@Status=&apos;Modified&apos;]) &gt; 0">
													...
													<xsl:if test="n1:ObjectsCollection">
														<fo:table border-collapse="collapse" font-size="xx-small" table-layout="fixed" width="100%">
															<fo:table-column column-width="4cm"/>
															<fo:table-column column-width="4cm"/>
															<fo:table-column column-width="4cm"/>
															<fo:table-column column-width="3cm"/>
																															...
																															<fo:table-cell padding="0" display-align="center">
																																<fo:block-container overflow="hidden">
																																	<fo:block text-align="left">
																																		...
																																		<fo:table font-size="xx-small" font-style="italic" width="12cm" table-layout="fixed" border-spacing="0">
																																			<fo:table-column column-width="4cm"/>
																																			<fo:table-column column-width="4cm"/>
																																			<fo:table-column column-width="4cm"/>
															...
															<fo:table-header white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" start-indent="0pt">
																<xsl:variable name="altova:tablerows">
																	<fo:table-row>
																		...
																		<fo:table-cell background-color="#d9f5ff" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thin" border-right-color="black" border-right-style="solid" border-right-width="thin" border-top-color="black" border-top-style="solid" border-top-width="thin" font-weight="bold" padding="3" display-align="center">
																			<fo:block-container overflow="hidden">
																				<fo:block text-align="center">
																					<fo:inline>
																						<xsl:text>Target Name</xsl:text>
											...
											<xsl:when test="n1:IsDMDImport = &apos;Y&apos;">
												...
												<xsl:if test="n1:ObjectsCollection">
													<fo:table table-layout="fixed" width="100%" border-spacing="0">
														...
														<fo:table-column column-width="3cm"/>
														<fo:table-column column-width="2cm"/>
														<xsl:variable name="altova:CurrContextGrid_183" select="."/>
														<fo:table-header background-color="#d9f5ff" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" start-indent="0pt">
															<xsl:variable name="altova:tablerows">
																<fo:table-row>
																	...
																	<xsl:for-each select="n1:ObjectDetails">
																		<xsl:for-each select="n1:Object">
																			<fo:table-row>
																				...
																				<fo:table-cell background-color="#ecfefa" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thin" border-right-color="black" border-right-style="solid" border-right-width="thin" font-size="xx-small" padding="3" display-align="center">
																					<fo:block-container overflow="hidden">
																						<fo:block text-align="left">
																							<xsl:choose>
																								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
																			...
																			<xsl:for-each select="n1:PropertiesCollection">
																				<xsl:choose>
																					<xsl:when test="count( n1:PropertyDetails ) &gt;0">
																						<fo:table-row>
																							<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thin" border-left-color="black" border-left-style="solid" border-left-width="thin" font-size="xx-small" padding="3" display-align="center">
																								<fo:block-container overflow="hidden">
																									<fo:block text-align="left"/>
																								</fo:block-container>
																							</fo:table-cell>
																							<fo:table-cell number-columns-spanned="4" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thin" border-right-color="black" border-right-style="solid" border-right-width="thin" font-size="xx-small" padding="3" display-align="center">
																								<fo:block-container overflow="hidden">
																									<fo:block text-align="left">
																										<fo:inline-container>
																											<fo:block>
																										...
																										<fo:table table-layout="fixed" width="100%" border-spacing="0">
																											<fo:table-column column-width="3cm"/>
																											<fo:table-column column-width="13cm"/>
																											<xsl:variable name="altova:CurrContextGrid_205" select="."/>
																											<fo:table-body start-indent="0pt">
																												<xsl:variable name="altova:tablerows">
																													<fo:table-row>
																														<fo:table-cell font-size="xx-small" padding="0" display-align="center">
																															<fo:block-container overflow="hidden">
																																<fo:block text-align="left"/>
																															</fo:block-container>
																														</fo:table-cell>
																																...
																																<fo:block text-align="left">
																																	...
																																	<fo:table font-style="italic" width="12cm" table-layout="fixed" border-spacing="0">
																																		...
																																		<fo:table-body start-indent="0pt">
																																			<xsl:variable name="altova:tablerows">
																																				<fo:table-row height="0.01cm">
																																					<fo:table-cell border-bottom-color="black" border-bottom-style="dotted" border-bottom-width="thin" font-size="xx-small" padding="3" display-align="center">
																																						<fo:block-container overflow="hidden">
																																							<fo:block text-align="left"/>
																																						</fo:block-container>
																																					</fo:table-cell>
																																				...
																																				<xsl:for-each select="n1:PropertyDetails">
																																					<fo:table-row>
																																						<fo:table-cell border-bottom-color="black" border-bottom-style="dotted" border-bottom-width="thin" border-left-color="black" border-left-style="dotted" border-left-width="thin" border-right-color="black" border-right-style="dotted" border-right-width="thin" font-size="xx-small" padding="3" display-align="center">
																																							<fo:block-container overflow="hidden">
																																								<fo:block text-align="left">
																																									<xsl:choose>
																																										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
																																						...
																																						<fo:table-cell border-bottom-color="black" border-bottom-style="dotted" border-bottom-width="thin" border-right-color="black" border-right-style="dotted" border-right-width="thin" font-size="xx-small" padding="3" display-align="center">
																																							<fo:block-container overflow="hidden">
																																								<fo:block text-align="left">
																																									<xsl:choose>
																																										<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
															...
															<xsl:variable name="altova:tablerows">
																<xsl:for-each select="n1:ObjectsCollection">
																	<xsl:for-each select="n1:ObjectDetails">
																		<xsl:for-each select="n1:Object">
																			<fo:table-row>
																				<fo:table-cell background-color="#ecfefa" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thin" border-left-color="black" border-left-style="solid" border-left-width="thin" border-right-color="black" border-right-style="solid" border-right-width="thin" font-size="xx-small" padding="3" display-align="center">
																					<fo:block-container overflow="hidden">
																						<fo:block text-align="left">
																							<xsl:choose>
																								<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
																			...
																			<xsl:for-each select="n1:PropertiesCollection">
																				<xsl:choose>
																					<xsl:when test="count( n1:PropertyDetails ) &gt;0">
																						<fo:table-row>
																							<fo:table-cell number-columns-spanned="4" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thin" border-left-color="black" border-left-style="solid" border-left-width="thin" border-right-color="black" border-right-style="solid" border-right-width="thin" font-size="xx-small" padding="3" display-align="center">
																								<fo:block-container overflow="hidden">
																									<fo:block text-align="left">
																										<fo:inline-container>
																											<fo:block>
																																...
																																<fo:block text-align="left">
																																	...
																																	<xsl:if test="n1:PropertyDetails">
																																		<fo:table font-size="xx-small" font-style="italic" width="12cm" table-layout="fixed" border-spacing="0">
																																			...
																																			<fo:table-column column-width="4cm"/>
																																			<fo:table-column column-width="4cm"/>
																																			<xsl:variable name="altova:CurrContextGrid_244" select="."/>
																																			<fo:table-body start-indent="0pt">
																																				<xsl:variable name="altova:tablerows">
																																					<xsl:for-each select="n1:PropertyDetails">
																																						<fo:table-row>
																																							<fo:table-cell border-bottom-color="black" border-bottom-style="dotted" border-bottom-width="thin" border-left-color="black" border-left-style="dotted" border-left-width="thin" border-right-color="black" border-right-style="dotted" border-right-width="thin" border-top-color="black" border-top-style="dotted" border-top-width="thin" font-size="xx-small" padding="3" display-align="center">
																																								<fo:block-container overflow="hidden">
																																									<fo:block text-align="left">
																																										<xsl:choose>
																																											<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
																																							...
																																							<fo:table-cell border-bottom-color="black" border-bottom-style="dotted" border-bottom-width="thin" border-right-color="black" border-right-style="dotted" border-right-width="thin" border-top-color="black" border-top-style="dotted" border-top-width="thin" font-size="xx-small" padding="3" display-align="center">
																																								<fo:block-container overflow="hidden">
																																									<fo:block text-align="left">
																																										<xsl:choose>
																																											<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
