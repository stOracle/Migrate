						...
						<xsl:for-each select="n1:TablesCollection">
							<xsl:for-each select="n1:TableDetails">
								...
								<xsl:if test="count( n1:ConstraintsCollection )">
									...
									<br/>
									<xsl:variable name="altova:table">
										<table style="border-collapse:collapse; width:25cm; " border="0" cellpadding="3" cellspacing="0" width="100%" altova:hide-rows="body-empty" altova:hide-cols="body-empty">
																	...
																	<xsl:if test="count( n1:RangesCollection ) != 0">
																		<xsl:variable name="altova:table">
																			<table style="border-collapse:collapse; width:18.5cm; " border="0" cellpadding="3" cellspacing="0">
																				...
																				<thead style="background-color:#d9f5ff; ">
																					<tr>
																						<th colspan="3" style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-left-color:black; border-left-style:solid; border-left-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; border-top-color:black; border-top-style:solid; border-top-width:thin; font-size:xx-small; font-weight:bold; text-align:center; vertical-align:top; width:3cm; ">
																							<span>
																					...
																					<tr>
																						<th style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-left-color:black; border-left-style:solid; border-left-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; font-size:xx-small; font-weight:bold; text-align:center; vertical-align:top; width:3cm; ">
																							<span>
																								<xsl:text>Begin Value</xsl:text>
																							</span>
																						</th>
																						<th style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; font-size:xx-small; font-weight:bold; text-align:center; vertical-align:top; width:3cm; ">
																							<span>
																								<xsl:text>End Value</xsl:text>
																							</span>
																						</th>
																						<th style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; font-size:xx-small; font-weight:bold; text-align:center; vertical-align:top; width:12.5cm; ">
																							<span>
																								<xsl:text>Description</xsl:text>
																							</span>
																						</th>
																	...
																	<xsl:if test="count( n1:ValueListsCollection ) != 0">
																		...
																		<xsl:variable name="altova:table">
																			<table style="border-collapse:collapse; width:18.5cm; " border="0" cellpadding="3" cellspacing="0">
																				...
																				<thead style="background-color:#d9f5ff; ">
																					<tr>
																						<th colspan="2" style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-left-color:black; border-left-style:solid; border-left-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; border-top-color:black; border-top-style:solid; border-top-width:thin; font-size:xx-small; font-weight:bold; text-align:center; vertical-align:top; width:3cm; ">
																							<span>
																					...
																					<tr>
																						...
																						<th style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; font-size:xx-small; font-weight:bold; text-align:center; vertical-align:top; width:15.5cm; ">
																							<span>
																								<xsl:text>Description</xsl:text>
																							</span>
																						</th>
																	...
																	<xsl:if test="count( n1:CheckConstraintsCollection ) != 0">
																		...
																		<xsl:variable name="altova:table">
																			<table style="border-collapse:collapse; width:18.5cm; " border="0" cellpadding="3" cellspacing="0">
																				...
																				<thead style="background-color:#d9f5ff; ">
																					<tr>
																						<th colspan="2" style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-left-color:black; border-left-style:solid; border-left-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; border-top-color:black; border-top-style:solid; border-top-width:thin; font-size:xx-small; font-weight:bold; text-align:center; vertical-align:top; width:15.5cm; ">
																							<span>
																					...
																					<tr>
																						<th style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-left-color:black; border-left-style:solid; border-left-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; font-size:xx-small; font-weight:bold; text-align:center; vertical-align:top; width:15.5cm; ">
																							<span>
