...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="http://oracle.com/datamodeler/reports/objectscomparison" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link n1 sps xbrldi xbrli xlink xs xsd xsi">
												...
												<xsl:for-each select="n1:PropertiesCollection">
													<xsl:choose>
														<xsl:when test="count( n1:PropertyDetails ) &gt;0">
															...
															<xsl:text>\itap</xsl:text>
															<xsl:value-of select="$templatetablelevel + 3"/>
															<xsl:text>\ql\sl0\fs16\i </xsl:text>
															<xsl:text>\fs24\i0</xsl:text>
	...
	<xsl:template name="altova:Section_0_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="6.71"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		...
		<xsl:variable name="altova:nSumColumnWidthsTw_17" select="round(9639.30)"/>
		...
		<xsl:variable name="altova:nColumnWidthTw_17_0" select="round(4.72 * 1440 * $altova:TableWidthFactor_17)"/>
	...
	<xsl:template name="altova:Section_0_FooterLeft">
		...
		<xsl:variable name="altova:nSumColumnWidthsTw_18" select="round(9639.30)"/>
		...
		<xsl:variable name="altova:nColumnWidthTw_18_0" select="round(4.72 * 1440 * $altova:TableWidthFactor_18)"/>
