	...
	<xsl:template name="altova:DocumentSection_0">
		...
		<xsl:for-each select="$XML">
			<xsl:for-each select="n1:UDP">
				...
				<xsl:variable name="altova:nSumColumnWidthsTw_1" select="round(13609.80)"/>
				...
				<xsl:variable name="altova:nColumnWidthTw_1_0" select="round(1.97 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:variable name="altova:nColumnWidthTw_1_1" select="round(1.97 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:variable name="altova:nColumnWidthTw_1_2" select="round(0.39 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:variable name="altova:nColumnWidthTw_1_3" select="round(1.57 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:variable name="altova:nColumnWidthTw_1_4" select="round(1.77 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:variable name="altova:nColumnWidthTw_1_5" select="round(1.18 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:variable name="altova:nColumnWidthTw_1_6" select="round(0.59 * 1440 * $altova:TableWidthFactor_1)"/>
				<xsl:text>\pard</xsl:text>
				<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
				<xsl:text>\itap</xsl:text>
				<xsl:value-of select="$templatetablelevel + 1"/>
				...
				<xsl:for-each select="n1:UDPCollection">
					<xsl:for-each select="n1:UDPDetails">
						...
						<xsl:call-template name="write-text">
							<xsl:with-param name="text">
								<xsl:value-of select="translate(string(n1:Name), ' ', '_')"/>
							</xsl:with-param>
						</xsl:call-template>
						<xsl:text>}</xsl:text>
						<xsl:choose>
							<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">
								<xsl:for-each select="n1:Name">
									...
									<xsl:text>\itap</xsl:text>
									<xsl:value-of select="$templatetablelevel + 1"/>
									<xsl:text>\ql\sl0\fs16\s1\f0\fs24\sl0\li240 </xsl:text>
									<xsl:call-template name="write-text">
										<xsl:with-param name="text">
						...
						<xsl:if test="count(n1:ObjectsScopeCollection)">
							...
							<xsl:variable name="altova:nTableWidthIn_2">
								<xsl:choose>
									<xsl:when test="1.96850 &gt; $altova:nColumnWidthTw_1_4 - 0.02000 - 0.03125 - 0.03125">
										<xsl:value-of select="$altova:nColumnWidthTw_1_4 - 0.02000 - 0.03125 - 0.03125"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:value-of select="1.96850"/>
									</xsl:otherwise>
								</xsl:choose>
							</xsl:variable>
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_2" select="round(2269.22)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_2_0" select="round(0.79 * 1440 * $altova:TableWidthFactor_2)"/>
							<xsl:variable name="altova:nColumnWidthTw_2_1" select="round(0.39 * 1440 * $altova:TableWidthFactor_2)"/>
							<xsl:variable name="altova:nColumnWidthTw_2_2" select="round(0.39 * 1440 * $altova:TableWidthFactor_2)"/>
							<xsl:text>\pard</xsl:text>
							...
							<xsl:for-each select="n1:ObjectsScopeCollection">
								<xsl:for-each select="n1:ObjectDetails">
									...
									<xsl:variable name="altova:nTableWidthIn_3" select="$altova:nColumnWidthTw_2_2 div 1440 * 1.00000 - 0.02000 - 0.03125 - 0.03125"/>
									...
									<xsl:variable name="altova:nSumColumnWidthsTw_3" select="round(567.43)"/>
									...
									<xsl:variable name="tablestyle3">
										...
										<xsl:text>\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
									</xsl:variable>
									...
									<xsl:variable name="altova:RowStyle7">
										...
										<xsl:text>\clvertalc\clpadl30\clpadfl3\clpadb30\clpadfb3\clpadt30\clpadft3\clpadr30\clpadfr3\clcbpat</xsl:text>
										<xsl:call-template name="altova:GetColorID">
											<xsl:with-param name="text">
												<xsl:value-of select="n1:Color"/>
											</xsl:with-param>
										</xsl:call-template>
						...
						<xsl:if test="count(n1:LOVCollection)">
							...
							<xsl:variable name="altova:nTableWidthIn_4">
								<xsl:choose>
									<xsl:when test="0.78740 &gt; $altova:nColumnWidthTw_1_5 - 0.02000 - 0.03125 - 0.03125">
										<xsl:value-of select="$altova:nColumnWidthTw_1_5 - 0.02000 - 0.03125 - 0.03125"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:value-of select="0.78740"/>
									</xsl:otherwise>
								</xsl:choose>
							</xsl:variable>
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_4" select="round(850.89)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_4_0" select="round(0.59 * 1440 * $altova:TableWidthFactor_4)"/>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 2 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
							<xsl:value-of select="$templatetablelevel + 2"/>
