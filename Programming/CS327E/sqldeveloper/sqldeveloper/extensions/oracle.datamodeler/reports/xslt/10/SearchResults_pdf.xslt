...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="http://oracle.com/datamodeler/reports/searchresults" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link n1 sps xbrldi xbrli xlink xs xsd xsi">
																...
																<xsl:for-each select="n1:CompanyName">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_4),'&#x200B;')">
																			<fo:block border-collapse="collapse" empty-cells="show" font-family="Georgia" font-size="8pt" font-weight="bold" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
																				<xsl:copy-of select="$value-of-template_4"/>
																			</fo:block>
																		</xsl:when>
																		<xsl:otherwise>
																			<fo:inline border-collapse="collapse" empty-cells="show" font-family="Georgia" font-size="8pt" font-weight="bold" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
																				<xsl:copy-of select="$value-of-template_4"/>
																			</fo:inline>
																		</xsl:otherwise>
																	</xsl:choose>
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block font-family="Tahoma" font-size="xx-small" border-collapse="collapse" empty-cells="show" font-weight="normal" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
						<xsl:for-each select="$XML">
							...
							<fo:block border-collapse="collapse" empty-cells="show" font-size="medium" font-weight="bold" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" margin-right="100% - 100%" text-align="center" space-before="0" space-after="0" margin="0pt">
								<xsl:for-each select="n1:SearchResults">
														...
														<xsl:variable name="altova:tablerows">
															<fo:table-row background-color="#d9f5ff" border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
																<xsl:variable name="bColumnCondition_0x80AD230">
																	<xsl:for-each select="$altova:CurrContextGrid_9">
													...
													<xsl:variable name="altova:tablerows">
														<fo:table-row background-color="#d9f5ff" border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
															<xsl:variable name="bColumnCondition_0x88825A0">
																<xsl:for-each select="$altova:CurrContextGrid_70">
																	<xsl:value-of select="$s0_c1_show"/>
																</xsl:for-each>
															</xsl:variable>
							...
							<xsl:variable name="altova:tablerows">
								<fo:table-row background-color="#f2fff6" border-collapse="collapse" empty-cells="show" font-weight="bold" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
									<xsl:variable name="bColumnCondition_0x887E9A0">
										<xsl:for-each select="$altova:CurrContextGrid_132">
									...
									<xsl:variable name="altova:tablerows">
										<fo:table-row border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
											<xsl:variable name="bColumnCondition_0x88804D0">
												<xsl:for-each select="$altova:CurrContextGrid_163">
													<xsl:value-of select="$c1_show = &apos;true&apos;"/>
												</xsl:for-each>
											</xsl:variable>
	...
	<xsl:template name="Single_CRLF">
		...
		<fo:block border-collapse="collapse" empty-cells="show" font-size="xx-small" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" margin-right="100% - 100%" space-before="0" space-after="0" margin="0pt">
			<fo:inline border-collapse="collapse" empty-cells="show" font-size="8pt" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
				<xsl:text>&#160;</xsl:text>
			</fo:inline>
		</fo:block>
	</xsl:template>
	...
	<xsl:template name="Wide_CRLF">
		...
		<fo:block border-collapse="collapse" empty-cells="show" font-size="xx-small" margin-bottom="0.7em" margin-top="0.7em" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" margin-right="100% - 100%" margin="0pt"/>
	</xsl:template>
